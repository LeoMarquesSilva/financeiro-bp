-- Racional de publicações: inclui PUBLICAÇÃO - ESOCIAL (SharePoint).
-- UI e Excel leem as colunas retornadas por esta RPC.
...
COMMENT ON FUNCTION public.escritorio_levantamento_racional_v2(text, date, date, text[], text, text, integer) IS
  'Racional levantamento Escritório — publicações filtradas por Criado; inclui E-SOCIAL.';
