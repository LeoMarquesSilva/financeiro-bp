-- Ranking Tarefas: excluir TIPO DO AGENDAMENTO do filtro visual do BI
-- (não é: CIÊNCIA NF, ABERT. DE PASTA, DUPLICIDADE, RENÚNCIA e combinações).
...
COMMENT ON FUNCTION public.eficiencia_ops_legais_tarefas_ranking(date, date) IS
  'BI Ops Legais / TAREFAS: ranking flip cards. Pub exclui TIPO DO AGENDAMENTO CIÊNCIA NF, ABERT. DE PASTA, DUPLICIDADE, RENÚNCIA*.';
