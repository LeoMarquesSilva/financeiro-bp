-- Separa quitado_outro_mes em antecipado vs pago após o mês de vencimento.
...
COMMENT ON FUNCTION public.receita_previsto_fechamento_mes(integer, integer) IS
  'Previsto = quitado no mês + antecipado + pago depois + em aberto. quitado_outro_mes = antecipado + pago_depois.';
