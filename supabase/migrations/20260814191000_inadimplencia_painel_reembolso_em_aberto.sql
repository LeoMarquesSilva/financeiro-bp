-- Painel Inadimplência (lista, KPIs, export, dashboard): reembolso de despesas
-- entra com TODOS os títulos em aberto (vencidos e a vencer).
-- Honorários da cota continuam só vencidos. Não altera Receita / cota.
...
COMMENT ON VIEW public.clients_inadimplencia_list IS
  'Painel Inadimplência: saldo do grupo = honorários vencidos (cota) + reembolso de despesas em aberto. Fonte de cards, KPIs, export e dashboard.';
