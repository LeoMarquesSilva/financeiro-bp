-- Valor em atraso por grupo desconsiderando clientes inativos (categoria = 'Cliente inativo').
...
fin_sum AS (
  SELECT
    ...
    COALESCE(
      sum(f_1.valor_em_atraso) FILTER (WHERE COALESCE(p.categoria, '') <> 'Cliente inativo'),
      0::numeric
