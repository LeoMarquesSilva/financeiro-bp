-- Publicações sem vistado_por não entram no KPI nem no racional de vistagem.
-- Reverte 20260805190000 (sem_filtro_usuario) para a população com responsável identificado.
...
COMMENT ON FUNCTION public.eficiencia_sla_vistagem_mensal(integer, boolean, text) IS
  'SLA Vistagem D+1 mensal. Exige vistado_por preenchido; Trabalhista fora da vistagem normal.';
