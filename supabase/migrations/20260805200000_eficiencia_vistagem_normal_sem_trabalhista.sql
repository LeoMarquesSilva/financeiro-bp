...
-- Consolidado: exclui a área; filtro Trabalhista: série vazia (Overview exibe "-").
...
COMMENT ON FUNCTION public.eficiencia_sla_vistagem_mensal(integer, boolean, text) IS
  'SLA Vistagem D+1 mensal. Trabalhista não entra em vistagem normal; filtro Trabalhista retorna vazio.';
