...
export const inadimplenciaService = {
  ...
  async update(id: string, input: Partial<CreateClienteInput> & { status_classe?: InadimplenciaClasse; pessoa_id?: string | null; data_vencimento?: string | null; contato?: string | null; observacoes_gerais?: string | null; ultima_providencia?: string; data_providencia?: string; follow_up?: string; data_follow_up?: string }) {
